...
## Implementation`
  ...
  main.variable(observer("Legend")).define("Legend", ["d3"], function (d3) {
    return (
  ...
  main.variable(observer("legend")).define("legend", ["Legend"], function (Legend) {
    return (
      function legend({
        color,
        ...options
  ...
  main.variable(observer("Swatches")).define("Swatches", ["d3", "htl"], function (d3, htl) {
    return (
...
.${id}::before {
  ...
  main.variable(observer("swatches")).define("swatches", ["Swatches"], function (Swatches) {
    return (
      function swatches({
        color,
        ...options
